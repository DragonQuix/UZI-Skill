---
title: "银行|财务报表|公司接口|香港|API文档|开放平台 - 理杏仁"
...
| stockCodes | Yes | Array | 股票代码数组。 stockCodes长度>=1且<=100，格式如下：\["01398"\]。  请参考 [股票信息API](https://www.lixinger.com/open/api/detail?api-key=hk/company) 获取合法的stockCode。  需要注意的是，当传入startDate时只能传入一个股票代码。 |
