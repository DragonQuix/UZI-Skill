...
[![Hermes Compatible](https://img.shields.io/badge/Hermes-Compatible-FFD700)](INSTALL-HERMES.md)
...
**Hermes 用户**：`hermes skills install wbh604/UZI-Skill/skills/deep-analysis` 即可。详见 [INSTALL-HERMES.md](INSTALL-HERMES.md)。
